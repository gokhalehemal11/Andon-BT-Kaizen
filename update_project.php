    ...
    <div id="full_admin" class="container-contact100">
      <div class="wrap-contact100">
       ...
       <!--    <div
          ...
          <?php 
            $q= "SELECT * FROM projects where `name`= '$project'";
          ...
          <div class="wrap-input100 validate-input">
            ...
            <textarea class="input100" name="stations"><?php echo $stations; ?></textarea>
            <span class="focus-input100"></span>
          </div>
...
if (isset($_POST['update_project'])) {
  ...
  $query= "UPDATE `projects` SET `name` ='$project_sel', `stations` = '$stations' WHERE  `name`='$project'";
  if (mysqli_query($conn, $query)) {
    echo "<script> alert('Project Updated!'); </script>";
    }
  else{
    echo "<script> alert('Project Update Failure!'); </script>";
  }
}
